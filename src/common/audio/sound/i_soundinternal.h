...
enum EChanFlag
{
	...
	CHANF_RESERVED = 0x20000,	// @Cockatrice - internal: Channel is reserved for a queued sound and is not yet playing
	CHANF_SINGULAR = 0x40000,	// Only start if no sound of this name is already playing.
};
