...
CUSTOM_CVAR(Float, r_sprite_distance_cull, 2000, CVAR_ARCHIVE | CVAR_GLOBALCONFIG)
{
...
CUSTOM_CVAR(Float, r_line_distance_cull, 4000, CVAR_ARCHIVE | CVAR_GLOBALCONFIG)
{
