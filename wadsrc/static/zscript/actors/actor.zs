...
class Actor : Thinker native
{
  ...
  // Called in TryMove if the mover ran into another Actor. This isn't called on players
	...
	native bool A_SpawnPooledParticle(class<ParticleDefinition> definition, double xoff = 0, double yoff = 0, double zoff = 0, double xvel = 0, double yvel = 0, double zvel = 0, double angle = 0, double scale = 1, int flags = 0, actor refActor = null);
